            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="text-wrap p-lg-6">
                        <form method="post" action="updatestudpassword4adminprocess.php" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <a href="viewstud.php"><button type="button" class="btn btn-primary">Cancel</button></a>
